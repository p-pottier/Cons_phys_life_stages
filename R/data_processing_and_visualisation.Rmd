...
```{r}
# Import survey data
raw_data <- read_csv("/Users/nicholaswu/Desktop/extracted_data_cons_phys_life_stages.csv")
...
ggplot(data = ls_exposed_stream,
  ...
  scale_x_continuous(
    breaks = seq(min(ls_exposed_yearly$Publication_year), # ls_exposed_yearly missing
